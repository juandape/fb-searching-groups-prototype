...
function SearchForm({ onSearch }) {
  ...
  return (
    <form onSubmit={handleSubmit} className='flex flex-col w-96 mx-auto'>
      ...
      /></label>
      <label className='mr-5 text-xl'>Radius
      <input
        type='number'
      ...
      /></label>
      <button type='submit' className='border-2 border-gray-300 p-2 rounded-lg w-20 ml-20 hover:bg-gray-300 mb-10'>Search</button>
    </form>
  );
}
